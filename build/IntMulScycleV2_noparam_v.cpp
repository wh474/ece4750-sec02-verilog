...
VIntMulScycleV2_noparam_t * VIntMulScycleV2_noparam_create_model( const char *vcd_filename ) {
  ...
  m     = new VIntMulScycleV2_noparam_t;
  model = new VIntMulScycleV2_noparam(context_ptr);
...
void VIntMulScycleV2_noparam_destroy_model( VIntMulScycleV2_noparam_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  VIntMulScycleV2_noparam * model = (VIntMulScycleV2_noparam *) m->_cffi_model;
...
void VIntMulScycleV2_noparam_comb_eval( VIntMulScycleV2_noparam_t * m ) {
...
void VIntMulScycleV2_noparam_seq_eval( VIntMulScycleV2_noparam_t * m ) {
...
void VIntMulScycleV2_noparam_assert_on( VIntMulScycleV2_noparam_t * m, bool enable ) {
...
bool VIntMulScycleV2_noparam_has_assert_fired( VIntMulScycleV2_noparam_t * m ) {
...
#if VLINETRACE
void VIntMulScycleV2_noparam_line_trace( VIntMulScycleV2_noparam_t * m, char* str ) {
  ...
  const svScope dut_scope = svGetScopeFromName("TOP.IntMulScycleV2_noparam.v");
  assert( dut_scope );
  svSetScope( dut_scope );

  VIntMulScycleV2_noparam::line_trace( words );
